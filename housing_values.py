# -*- coding: utf-8 -*-
"""housing_values.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17JU4UmdhoNXLR528bzEK6ECVgLASKmN4

**End-to-end Machine Learning project**

*Welcome to Machine Learning Housing Corp.! This task is to predict median house values in Californian districts, given a number of features from these districts.*
